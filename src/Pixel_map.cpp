...
/*
	Function finding the vertex index of given matrix coordinates for creation
	of graph based on the pixel map. In case of not finding the pixel with given
	coordinates, 0xFFFFFFFF is returned as an indication.

	Params:
	nodes	- reference to the vector of coordinates of each non-wall (0) field in
			  the pixel map
